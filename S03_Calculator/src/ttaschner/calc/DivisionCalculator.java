 ...
 * Alle Werte der Liste werden mit Hilfe von processCalculations mit dem Wert von modifier modifiziert (hier: dividiert).
 *
 */
public class DivisionCalculator implements CalculatorBehaviour {
