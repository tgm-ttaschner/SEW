 ...
 * Alle Werte der Liste werden mit Hilfe von processCalculations mit dem Wert von modifier modifiziert (hier: subtrahiert).
 *
 */
public class SubstractionCalculator implements CalculatorBehaviour {
	/**
